...
- **No built-in MCP rate limiter or audit-log exporter** — use `McpServer` auth/policy plus a gateway for throttling; JSONL audit export is tracked separately.
