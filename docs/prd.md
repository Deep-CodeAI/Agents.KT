...
### 12.6 AGNTCY Interoperability *(shipped — OASF export/import + Identity-verify + DIR Store/Search/Routing client; only DIR `List` + OCI referrers remain)*
